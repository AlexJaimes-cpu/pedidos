...
if ventas_df is not None:
    ...
    # Acumular ventas de diferentes Q
    ventas_por_punto = ventas_df.groupby(ventas_df.columns.intersection(['Samaria', 'Playa Dormida', 'Two Towers'])).sum()
    ventas_por_punto = ventas_por_punto.sum()
